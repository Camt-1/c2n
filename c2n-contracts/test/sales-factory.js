...
describe('SalesFactory', function () {
    ...
    beforeEach(async function () {
        ...
        C2NToken = await BreTokenFactory.deploy('C2N', 'C2N', ethers.parseUnits('100000000'), 18)
        BreToken2 = await BreTokenFactory.deploy('Bre2', 'BRE2', ethers.parseUnits('100000000'), 18)
